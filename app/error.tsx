  ...
  return (
    <main className="recovery-page">
      <section className="recovery-card">
        <span className="recovery-mark">A+</span>
        <p className="app-eyebrow">Aula+</p>
        <h1>No pudimos cargar esta sección.</h1>
        <p>Tu información no se ha perdido. Intenta cargarla nuevamente; si el problema continúa, contacta a la administración.</p>
